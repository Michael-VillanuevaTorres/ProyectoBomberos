...
class _statisticsState extends State<statistics> {
  ...
  Future<void> getStadistics() async {
    try {
      final responseweek = await http.get(
          Uri.parse('http://perrera.inf.udec.cl:1522/entrytime/summary/1/1'));
      final responsemonth = await http.get(
          Uri.parse('http://perrera.inf.udec.cl:1522/entrytime/summary/1/30'));
